  ...
  return (
    <div className="relative w-full">
      ...
      <motion.div 
        ...
        className="absolute inset-0 bg-[#4E7D8B]/10 blur-[120px] rounded-full z-0 pointer-events-none"
      ...
      <div className="w-full relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-[600] tracking-[-0.02em] text-title-primary mb-2 [-webkit-text-stroke:0.5px_currentcolor]">
            Polymood
          </h2>
          <p className="text-muted text-sm md:text-base max-w-2xl mx-auto">
            Au cœur de Kakkoï AI, notre algorithme ne se contente pas de répondre. Il simule la psychologie et les émotions de vos avatars.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch justify-items-center w-full">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
          className="card-glass p-5 flex flex-col items-start text-left w-full justify-center hover:border-[#4E7D8B]/40 hover:shadow-[0_20px_40px_rgba(78,125,139,0.2)] cursor-default"
          >
          ...
          className="w-40 h-40 border-2 border-dashed border-[#4E7D8B]/30 rounded-full flex items-center justify-center"
            ...
            >
              <motion.div
                ...
                style={{ willChange: "transform" }}
              />
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#E63946] to-[#4E7D8B] shadow-[0_0_40px_rgba(78,125,139,0.3)] animate-pulse relative z-20" />
            </motion.div>
            
            {/* Lignes de flux animées */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
               <Activity className="text-[#4E7D8B]/30" size={64} aria-hidden="true" />
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted text-xs leading-tight">Génération d'une réponse imprégnée de l'état émotionnel actuel de l'avatar.</p>
          </motion.div>
